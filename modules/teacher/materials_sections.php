...
$sections_sql = "
    SELECT s.*, 
           ...
           (SELECT COUNT(*) FROM learning_materials lm WHERE lm.section_id = s.id AND lm.subject_id = ?) as material_count
    FROM sections s
...
if (!empty($subject['program_id'])) {
    ...
    $sections_query->bind_param("iiisii", 
        $subject_id,
        $subject['branch_id'], 
        $current_ay_id, 
        $semester_str,
...
<div class="header-fixed-part d-flex justify-content-between align-items-center animate__animated animate__fadeInDown">
    <div>
        <h4 class="fw-bold mb-0" style="color: var(--blue);">
            <i class="bi bi-folder-fill me-2"></i><?php echo htmlspecialchars($subject['subject_code']); ?> - Materials
        </h4>
        <p class="text-muted small mb-0"><?php echo htmlspecialchars($subject['subject_title']); ?></p>
    </div>
    <a href="materials.php" class="btn btn-outline-secondary btn-sm px-4 shadow-sm">
...
<div class="body-scroll-part">
    ...
    <div class="subject-info-card animate__animated animate__fadeIn">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h5 class="fw-bold mb-2"><i class="bi bi-folder me-2"></i><?php echo htmlspecialchars($subject['subject_code']); ?> - <?php echo htmlspecialchars($subject['subject_title']); ?></h5>
            ...
            <div class="col-md-4 text-end">
                ...
                <small class="opacity-75">Sections to Manage</small>
            </div>
        </div>
    </div>

    <h5 class="mb-3"><i class="bi bi-collection text-primary me-2"></i>Select a Section to Manage Materials</h5>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-4 animate__animated animate__zoomIn delay-<?php echo $counter; ?>">
            <div class="section-card" onclick="openMaterials(<?php echo $section['id']; ?>, <?php echo $subject_id; ?>)">
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <div class="stat-pill">
                            <h4 class="mb-0 fw-bold" style="color: #6f42c1;"><?php echo $section['material_count']; ?></h4>
                            <small class="text-muted" style="font-size: 0.7rem;">Materials</small>
                        </div>
                    </div>
                ...
                <div class="card-footer-custom">
                    <i class="bi bi-cloud-arrow-up me-2"></i> Manage Materials
                </div>
            </div>
        </div>
        <?php 
...
<script>
function openMaterials(sectionId, subjectId) {
    window.location.href = 'materials_list.php?section_id=' + sectionId + '&subject_id=' + subjectId;
}
</script>
</body>
</html>
