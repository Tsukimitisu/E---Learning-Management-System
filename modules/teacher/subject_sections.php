...
<div class="header-fixed-part d-flex justify-content-between align-items-center animate__animated animate__fadeInDown">
    <div>
        <h4 class="fw-bold mb-0" style="color: var(--blue);">
            <i class="bi bi-journal-bookmark me-2"></i><?php echo htmlspecialchars($subject['subject_code']); ?>
        </h4>
...
<div class="body-scroll-part">
    ...
    <div class="subject-info-card animate__animated animate__fadeIn">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h5 class="fw-bold mb-2"><?php echo htmlspecialchars($subject['subject_code']); ?> - <?php echo htmlspecialchars($subject['subject_title']); ?></h5>
            ...
            <div class="col-md-4 text-end">
                ...
                <small class="opacity-75">Total Sections</small>
            </div>
        </div>
    </div>

    <h5 class="mb-3"><i class="bi bi-collection text-primary me-2"></i>Sections</h5>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-4 animate__animated animate__zoomIn delay-<?php echo $counter; ?>">
            <div class="section-card" onclick="viewStudents(<?php echo $section['id']; ?>, <?php echo $subject_id; ?>)">
                <div class="card-body">
...
<script>
function viewStudents(sectionId, subjectId) {
