...
// Debug: Check what branch_id we got
error_log("DEBUG: get_user_branch_id() returned: " . var_export($branch_id, true));
error_log("DEBUG: \$_SESSION['branch_id'] = " . var_export($_SESSION['branch_id'] ?? 'NOT SET', true));
error_log("DEBUG: \$_SESSION['user_id'] = " . var_export($_SESSION['user_id'] ?? 'NOT SET', true));

if ($branch_id === null) {
    error_log("ERROR: Branch ID is NULL for user " . $_SESSION['user_id']);
...
";
error_log("DEBUG: Students query for branch_id=$branch_id executed");
$students_result = $conn->query($students_query);
error_log("DEBUG: Students query returned " . ($students_result ? $students_result->num_rows : "FALSE") . " rows");

// Fetch all sections (classes) for this branch
$sections_query = "
    SELECT 
        cl.id,
        cl.section_name,
            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-header" style="background-color: #003366; color: white;">
                        <i class="bi bi-grid-3x3-gap"></i> All Available Sections
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center py-4 text-muted">
                            ...
                            <p class="mt-2">No sections available for this branch.</p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
